...
make_datatable <- function(cpg_name = NULL, gene_name = NULL, Chr = NULL, Start = NULL, End = NULL){
  ...
  anno_cpg <- anno_cpg %>% select(cpg, chr, start, end, 
         cpg_id, enhancers_id, genes_symbol, genes_tx_id, genes_id, pmd_id, 
         imprinted_dmr_general, imprinted_dmr_placenta)
}
...
```{r}
annoPlot_with_tracks <- function(cpg_name = NULL, gene_name = NULL, Chr = NULL, Start = NULL, End = NULL, cpg_number = 50, first_cpg = NULL, end_cpg = NULL, Tissue_type = unique(pDat$Tissue)){
