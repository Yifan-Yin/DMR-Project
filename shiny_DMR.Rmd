...
ui <- fluidPage(
  ...
  plotOutput('boxplot_trimester_total',  height = '500px', width = '84.5%'),
  plotOutput('boxplot_tissue_individual', width = '95%'),
  br(),
  plotOutput('boxplot_trimester_individual', width = '91.5%')
...
server <- function(input, output, session) {
    ...
    output$boxplot_trimester_individual <- renderPlot(
      {
        if (!is.null(event_cpg()))
        {
