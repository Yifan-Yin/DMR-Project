...
make_datatable <- function(cpg_name = NULL, gene_name = NULL, Chr = NULL, Start = NULL, End = NULL){
  if (!is.null(cpg_name))
  { #get cpg annotation 
  ...
  cpg_name <- find_cpgFromRegion(Chr, Start, End)
...
```{r}
annoPlot_withTracks <- function(cpg_name = NULL, gene_name = NULL, Chr = NULL, Start = NULL, End = NULL){
...
=======
         color = '', 
         title = title) 
>>>>>>> eccb1306bd35ca13f5edbd235466db21c2df5d7f
...
```{r}
find_cpgFromRegion <- function(Chr, Start, End){
...
find_cpgFromRegion('chr4', 40439821,40439823)
```
