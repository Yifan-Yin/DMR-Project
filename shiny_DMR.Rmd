      ...
      sidebarPanel(
           ...
           tabPanel('Gene Input',
            ...
            #page of region input
                    ...
                    hr(), 
                    #numeric inputs to control the number of cpgs to show
                    numericInput('cpg_number_input_region', 'CpG number to plot', value = 50),
                    actionButton('submit_cpg_number_region','Submit'),
                    br(),
                    hr(),
                    #numeric inputs to control which sets of cpgs to show
                    numericInput('first_cpg_region', 'First CpG to plot', value = 1),
                    numericInput('end_cpg_region', 'End CpG to plot', value = 50),
                    actionButton('submit_cpg_set_region','Submit')
                                )
                       ),
